class Soll < Formula
  ...
  on_macos do
    url "https://github.com/marginallyuseful/homebrew-tap/releases/download/13/soll-macos-arm64"
    sha256 "e136adc28302c0a4736b62241b2fe3af7567b43e6e7b8680fab19a6eef2a5afd"
  end

  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/marginallyuseful/homebrew-tap/releases/download/13/soll-linux-arm64"
      sha256 "dc8f3aa48665607fe6114bece7855aa97bf11fd5530a1eed88295934bc76598b"
    end
    if Hardware::CPU.intel?
      url "https://github.com/marginallyuseful/homebrew-tap/releases/download/13/soll-linux-x64"
