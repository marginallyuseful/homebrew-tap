class Soll < Formula
  ...
  version "soll-0.0.1-9fd7ab95"
  license :cannot_represent

  on_macos do
    url "https://github.com/marginallyuseful/homebrew-tap/releases/download/soll-0.0.1-9fd7ab95/soll-macos-arm64"
    sha256 "a0e93232514ea2b0bcf94cf96bab0e71fe0a2bb1b1c351974fab2a4431d67e0b"
  end

  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/marginallyuseful/homebrew-tap/releases/download/soll-0.0.1-9fd7ab95/soll-linux-arm64"
      sha256 "f43db23c410bc4b37ff035270f640a50335eccf26cdc24639020ae1e4f5fc355"
    end
    if Hardware::CPU.intel?
      url "https://github.com/marginallyuseful/homebrew-tap/releases/download/soll-0.0.1-9fd7ab95/soll-linux-x64"
